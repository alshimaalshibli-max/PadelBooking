...
public class CreateBookingDto
{
    [StringLength(
        100,
        MinimumLength = 2,
        ErrorMessage = "Customer name must be between 2 and 100 characters when provided.")]
    ...
    [Range(
        1,
        12,
        ErrorMessage = "Booking hours must be between 1 and 12.")]
    public int Hours { get; set; }

    [Required(ErrorMessage = "Payment method is required.")]
    [RegularExpression(
        @"^(Cash|Thawani)$",
        ErrorMessage = "Payment method must be Cash or Thawani.")]
